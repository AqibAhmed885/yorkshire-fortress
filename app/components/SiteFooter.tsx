  ...
  return (
    <footer className="yfs-footer" id="contact">
      ...
      <div className="yfs-footer-main">
        ...
        <div><h3>Explore</h3><a href="/about">About us</a><a href="/services">Services</a><a href="/sectors">Sectors</a><a href="/insights">Insights & news</a><a href="/contact">Contact</a></div>
