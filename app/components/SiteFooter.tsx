  ...
  return (
    <footer className="bg-onyx text-white" id="contact">
      ...
      <div className="mx-auto grid w-[calc(100%_-_48px)] max-w-[1440px] grid-cols-[1.5fr_.7fr_1.2fr] gap-[8vw] py-[75px] max-lg:grid-cols-2 max-sm:w-[calc(100%_-_32px)] max-sm:grid-cols-1">
        ...
        <div className="flex flex-col gap-3"><h3 className="mb-1.5 text-[13px] font-extrabold uppercase tracking-[.13em] text-tan">Explore</h3><a className={footerLink} href="/about">About us</a><a className={footerLink} href="/services">Services</a><a className={footerLink} href="/sectors">Sectors</a><a className={footerLink} href="/insights">Insights & news</a><a className={footerLink} href="/contact">Contact</a></div>
        <div className="flex flex-col gap-3"><h3 className="mb-1.5 text-[13px] font-extrabold uppercase tracking-[.13em] text-tan">Contact</h3><a className={footerLink} href="mailto:info@yorkshirefortresssecurity.co.uk"><Mail /> info@yorkshirefortresssecurity.co.uk</a><span className={footerLink}><MapPin /> Yorkshire, United Kingdom</span><a className={footerLink} href="/contact"><Phone /> Request a callback</a></div>
      </div>
